...
- Uses one fresh, zero-tool Hermes call per action window, avoiding an ever-growing raw gameplay transcript
...
`HERMES_PROVIDER`, and `HERMES_TIMEOUT_SECONDS` (the current client default
