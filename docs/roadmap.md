...
**Where the project is now:** the public waitlist closed on 1 August 2026, and closed beta 1 opens at 06:00 UTC on 7 August 2026 and runs to 21 August 2026. The arena score is displayed as **CP** through closed beta 1 and 2, and as **HP** from open beta onward — the same off-chain score either way.
